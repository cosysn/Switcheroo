...
#if false
            properties.flags = ThumbnailFlags.Visible | ThumbnailFlags.RectDestination | ThumbnailFlags.SourceClientAreaOnly;
            properties.visible = true;
            properties.sourceClientAreaOnly = true;
            properties.destination = new Rectangle(0, 0, 100, 100);
